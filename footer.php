	...
	<footer id="footer">
		...
		<?php if ( has_nav_menu('footer') ): ?>
			<div id="wrap-nav-footer" class="wrap-nav">
				<?php \Halftype\Nav::nav_menu(array('theme_location'=>'footer','menu_id' => 'nav-footer','fallback_cb'=> false)); ?>
			</div>
		<?php endif; ?>
			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="copyright">
						...
						<?php else: ?>
							<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'halftype' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'halftype' ); ?></p>
						<?php endif; ?>
					</div><!--/#copyright-->
					
					<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
					<div id="credit">
						<p><?php esc_html_e('Powered by','halftype'); ?> <a href="<?php esc_url( __( 'https://wordpress.org', 'halftype' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','halftype'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
