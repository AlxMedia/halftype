...
Kirki::add_field( 'halftype_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'halftype' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'halftype' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'halftype' ) . ' <a href="https://fontawesome.com/icons?d=gallery&s=brands&m=free" target="_blank"><strong>' . esc_html__( 'View All', 'halftype' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
